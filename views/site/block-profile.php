...
if(!empty($breadCrumbs['parentName'])){
    $this->params['breadcrumbs'][] = ['label' => $breadCrumbs['parentName'], 'url' => "/{$breadCrumbs['parentSlug']}"];
}

if(!empty($breadCrumbs['name'])){
    $this->params['breadcrumbs'][] = ['label' => $breadCrumbs['name'], 'url' => $breadCrumbs['parentSlug'] ? "/{$breadCrumbs['parentSlug']}/{$breadCrumbs['slug']}" : "/{$breadCrumbs['slug']}" ];
}else{
