...
$this->title = 'Model Profile';
//$this->params['breadcrumbs'][] = $this->title;

$this->params['breadcrumbs'][] = ['label' => $breadCrumbs['name'], 'url' => "/{$breadCrumbs['parentSlug']}/{$breadCrumbs['slug']}"];
