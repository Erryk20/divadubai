...
use app\modules\admin\models\BlogsSearch;
...
class BlogsController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Blogs",
                    'content'=>'<span class="text-success">Create Blogs success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function saveFile($model){
        if(!empty($_FILES['Blogs']['name']['file'])){
            $upload = new \app\models\File();
            $upload->file = \yii\web\UploadedFile::getInstanceByName("Blogs[file]");
       
            $path = \Yii::getAlias("@webroot/images/blog/");
