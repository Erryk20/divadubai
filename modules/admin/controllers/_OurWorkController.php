...
use app\modules\admin\models\OurWorkSearch;
 ...
 */
class _OurWorkController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {    
        ...
        if (Yii::$app->request->post('hasEditable')) {
            ...
            $model = \app\models\OurWork::findOne([
                'info_user_id'=> $info_user_id
            ]);
            
            
            $type_name = \app\models\OurWork::itemAlias('type', $type);
            
            if($model == null){
                $model = new \app\models\OurWork();
