...
/**
 * DivaMediaController implements the CRUD actions for DivaMedia model.
 */
class DivaMediaController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Displays a single DivaMedia model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new DivaMedia model.
     * For ajax request will return json object
     * and for non-ajax request if creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate($target_id, $type)
    {
        $request = Yii::$app->request;
        $model = new DivaMedia();  
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                            Html::a('Create More',['create', 'target_id'=>$target_id, 'type'=>$type],['class'=>'btn btn-primary','role'=>'modal-remote'])
    ...
    /**
     * Updates an existing DivaMedia model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing DivaMedia model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
