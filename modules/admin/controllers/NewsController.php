...
class NewsController extends Controller
{
    ...
    {    
        ...
        if (Yii::$app->request->post('hasEditable')) {
            ...
            $value = null;
            foreach (Yii::$app->request->post('NewsSearch') as $item) {
...
//                return $this->redirect(['view', 'id' => $model->id]);
    ...
    public function actionSeo($id)
    {
        ...
        $model = \app\models\Seo::findOne(['id'=>$id, 'type_id'=>'4']); 
        if(empty($model)){
...
//                return $this->redirect(['view', 'id' => $model->id]);
    ...
    public function saveFile($model){
        if(!empty($_FILES['News']['name']['file'])){
            ...
            $upload->file = \yii\web\UploadedFile::getInstanceByName("News[file]");
    ...
    protected function findModel($id)
    {
        $model = News::find()
            ...
            ->select([
                'n.id', 
                "CONCAT('images/news/', n.img) AS img", 
                'n.published', 
                'n.language', 
                'n.name', 
                'n.url', 
            ...
            ->leftJoin('language l', 'n.language = l.short_name')
            ->where(['n.id' => $id])
            ->one();
