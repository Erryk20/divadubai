 ...
 */
class _ServicesController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    public function saveFile($model){
        if(!empty($_FILES['Services']['name']['file'])){
            $upload = new \app\models\File();
            $upload->file = \yii\web\UploadedFile::getInstanceByName("Services[file]");
       
            $path = \Yii::getAlias("@webroot/images/service/");
