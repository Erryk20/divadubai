...
class MessageController extends Controller
{
    ...
    public function actionCreateSource()
    {
        ...
        $request = Yii::$app->request;
        $model = new \app\models\SourceMessage();  
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    ...
                    'content'=>$this->renderAjax('@admin/views/source-message/create', [
                        'model' => $model,
                    ]),
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                                Html::button('Save',['class'=>'btn btn-primary','type'=>"submit"])
                ...
                return [
                    ...
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                            Html::a('Create More',['message/create-source'],['class'=>'btn btn-primary','role'=>'modal-remote'])
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['@admin/views/source-message/view', 'id' => $model->id]);
            } else {
                return $this->render('create', [
                    'model' => $model,
                ]);
    ...
    {        
        ...
        $pks = '['.$pks.']';
        $pks = json_decode($pks, true); // Array or selected records primary keys
        
        foreach ( $pks as $pk ) {
            $model = $this->findModel($pk['id'], $pk['language']);
            $model->delete();
        }
