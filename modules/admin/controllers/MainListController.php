...
use app\modules\admin\models\MainListSearch;
...
class MainListController extends Controller
{
    ...
    public function actions() {
        return [
            'upload-photo' => [
                'class' => \app\components\UploadCrop::className(),
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new MainList",
                    'content'=>'<span class="text-success">Create MainList success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing MainList model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing MainList model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    public function saveFile($model){
        if(!empty($_FILES['MainList']['name']['file'])){
            $upload = new \app\models\File();
            $upload->file = \yii\web\UploadedFile::getInstanceByName("MainList[file]");
       
            $path = \Yii::getAlias("@webroot/images/main-list/");
