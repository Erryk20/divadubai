...
use app\modules\admin\models\ServiceCategoriesSearch;
...
class ServiceCategoriesController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new ServiceCategories",
                ...
                return [
                    ...
                    'title'=> "Create new ServiceCategories",
                    'content'=>'<span class="text-success">Create ServiceCategories success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update ServiceCategories #".$id,
    ...
    /**
     * Delete an existing ServiceCategories model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing ServiceCategories model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
