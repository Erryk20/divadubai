...
use app\modules\admin\models\ShareSearch;
...
class ShareController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $model = new Share();  
        $model->published = 1;
        $images = \app\models\File::getFiles("@webroot/images/share/");
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new share",
                    'content'=>'<span class="text-success">Create share success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing share model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing share model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
