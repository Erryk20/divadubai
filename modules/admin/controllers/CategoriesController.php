...
class CategoriesController extends Controller
{
    ...
    public function saveFile($model){
        if(!empty($_FILES['Categories']['name']['file'])){
            $upload = new \app\models\File();
            $upload->file = \yii\web\UploadedFile::getInstanceByName("Categories[file]");
       
            $path = \Yii::getAlias("@webroot/images/categories/");
    ...
    protected function findModel($id)
    {
        ...
        if (($model = Categories::getCategoriesUrl($id)) !== null) {
            return $model;
        } else {
