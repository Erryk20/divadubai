...
/**
 * Contacts_1Controller implements the CRUD actions for Contacts model.
 */
class ContactsController extends Controller
{
    ...
    {    
        ...
        if (($model = Contacts::findOne(1)) == null) {
        ...
        if ($model->load($request->post()) && $model->save()) {
            ...
            $searchModel = new \app\modules\admin\models\ContactsInfoSearch();
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new ContactsInfo",
                    'content'=>'<span class="text-success">Create ContactsInfo success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionTitle($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update ContactsInfo #",
                    'content'=>$this->renderAjax('title', [
                        'model' => $model,
                    ]),
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                                Html::button('Save',['class'=>'btn btn-primary','type'=>"submit"])
    ...
    /**
     * Delete an existing ContactsInfo model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing ContactsInfo model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
