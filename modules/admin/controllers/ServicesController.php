...
class ServicesController extends Controller
{
    ...
    /**
     * Displays a single ServicePage model.
     * @param integer $id
     * @return mixed
     */
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new ServicePage",
                    'content'=>'<span class="text-success">Create ServicePage success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing ServicePage model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing ServicePage model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    public function saveFile($model){
        if(!empty($_FILES['ServicePage']['name']['file'])){
            $upload = new \app\models\File();
            $upload->file = \yii\web\UploadedFile::getInstanceByName("ServicePage[file]");
