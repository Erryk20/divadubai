...
use app\modules\admin\models\ModelEventSearch;
 ...
 */
class ModelEventController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {    
        $searchModel = new ModelEventSearch();
        ...
        if($filter->load($request->get())){
            ...
            $params['ModelEventSearch'] = $getFilter;
