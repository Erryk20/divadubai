...
class PostsController extends Controller
{
    ...
    public function actionDelete($id)
    {
        ...
        \app\models\UserToggle::deleteItem('post', $id);
    ...
    {        
        ...
        foreach ( $pks as $pk ) {
            ...
            $model->delete();
            \app\models\UserToggle::deleteItem('post', $model->id);
        }
    ...
    public function saveFile($model){
        if(!empty($_FILES['Posts']['name']['file'])){
            $upload = new \app\models\File();
            $upload->file = \yii\web\UploadedFile::getInstanceByName("Posts[file]");
       
            $path = \Yii::getAlias("@webroot/images/posts/");
    ...
    {
        $model = Posts::find()
                ->select(['p.*', "IF(IFNULL(i.id, 0) = 0, 0, 1) AS 'introduction'"])
                ->from('posts p')
