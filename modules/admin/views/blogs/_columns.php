...
return [
    ...
    [
        ...
        'value'=>function($model){
            return kartik\helpers\Html::a($model->title, ['/site/blog', 'id'=>$model->id], ['target'=>"_blank", 'data-pjax'=>0]);
        } ,
    ],
//    [
//        'class'=>'\kartik\grid\DataColumn',
...
//        'vAlign'=>'middle',
//        'value'=>function($model){
//            return kartik\helpers\Html::a($model->slug, $model->slug, ['target'=>"_blank", 'data-pjax'=>0]);
//        } ,
//    ],
    [
        'attribute' => 'img',
        'format' => 'html',
        'value' => function($model){
            return $model->src ? $this->render('@app/views/blocks/thumbnail-img', ['url' => Yii::getAlias("@webroot/images/blog/{$model->src}"), 'width' => 200, 'height' => 100]): null;
        },
        'filter'=>false
    ],
    // [
    ...
    [
        ...
        'template' => '{view} {seo} {update} {delete}',
        'buttons'=>[
