...
return [
    ...
    // ],
        ...
        [
            ...
            'label' => 'Category',
            'attribute' => 'add_management',
            'value' => function($model) {
                return $model['add_management'] ? \app\models\PromotionsActivations::itemAlias('type', $model['add_management']) : null;
            },
            'vAlign' => 'middle',
            'filter' => app\models\PromotionsActivations::itemAlias('type'),
            'editableOptions' => function ($model, $key, $index) {
                $key = $model->id;
                return [
                    'name' => 'add_management',
                    'value' => \app\models\PromotionsActivations::itemAlias('type', $model['add_management']),
                    'asPopover' => true,
                    'header' => 'Type',
                    'inputType' => Editable::INPUT_DROPDOWN_LIST,
                    'data' => ['0' => 'Delete'] + app\models\PromotionsActivations::itemAlias('type'),
                    'options' => [
                        'class' => 'form-control',
                        'prompt' => 'Select type...',
                        'name' => 'promotion_type',
