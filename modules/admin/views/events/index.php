...
<div class="diva-media-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', ['/admin/diva-media/create', 'target_id'=>2, 'type'=>'events'],
                    ['role'=>'modal-remote','title'=> 'Create new Diva Media','class'=>'btn btn-default']).
                    
                    Html::a('<i class="glyphicon glyphicon-repeat"></i>', [''],
                    ['data-pjax'=>1, 'class'=>'btn btn-default', 'title'=>'Reset Grid']).
                     
                    Html::a('<div class="property-sider btn-group">Content</div>', ['/admin/diva/update', 'id'=>2, 'type'=>'events'],
                    ['role'=>'modal-remote','title'=> 'Update seo','class'=>'btn btn-default']).
                    
                    Html::a('<div class="property-sider btn-group">SEO</div>', ['/admin/seo/update', 'target_id'=>2, 'type'=>'events'],
                    ['role'=>'modal-remote','title'=> 'Update seo','class'=>'btn btn-default'])
                ],
            ],          
            'striped' => true,
