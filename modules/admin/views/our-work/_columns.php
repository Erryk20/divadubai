...
return [
    ...
    [
        ...
        'filter' => \app\models\ModelCategory::getListCategoryEvent(41),
    ],
    [
        'class'=>'\kartik\grid\DataColumn',
        'attribute'=>'gender',
    ...
    [
        ...
        'vAlign' => 'middle',
        'filter' => \app\models\ModelCategory::listSubcategoryInCategory(41),
        'editableOptions' => function ($model, $key, $index) {
            $key = $model->id;
            $data = \app\models\ModelCategory::listSubcategoryInCategory(41);
            return [
                'formOptions' => ['action' => ['/admin/promotions-activations', 'categories'=> $model->categories_id] ],
                'name' => 'subcategory',
                'asPopover' => true,
                'header' => 'Subcategory',
    ...
    [
        ...
        'value' => function ($model) {
            return SwitchInput::widget([
                        ...
                        'value' => ($model->active),
                        'options'=>['data-uid'=>$model->id, 'data-category-id'=> 4],
                        'pluginEvents' => [
                            "switchChange.bootstrapSwitch" => "function() {
                                ...
                                $.ajax({
                                    type: 'GET',
                                    url: '/admin/model-management/active',
