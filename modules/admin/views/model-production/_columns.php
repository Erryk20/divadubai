...
return [
    ...
    [
        ...
        'filter' => \app\models\ModelCategory::getListCategoryEvent(16),
    ],
    [
        'class'=>'\kartik\grid\DataColumn',
        'attribute'=>'name',
    ...
    [
        ...
        'vAlign' => 'middle',
        'filter' => \app\models\ModelCategory::listSubcategoryInCategory(16),
        'editableOptions' => function ($model, $key, $index) {
            $key = $model->id;
            $data = \app\models\ModelCategory::listSubcategoryInCategory(16);
            return [
                'formOptions' => ['action' => ['/admin/promotions-activations', 'categories'=> \app\models\ModelCategory::getListIdCategoriesForCategory(16)] ],
                'name' => 'subcategory',
                'asPopover' => true,
                'header' => 'Subcategory',
            ...
            return SwitchInput::widget([
                        ...
                        'pluginEvents' => [
                            "switchChange.bootstrapSwitch" => "function() {
                                ...
                                $.ajax({
                                    type: 'GET',
                                    url: '/admin/model-production/active',
                                    data: {id:id},
                                });
                            }",
                        ],
