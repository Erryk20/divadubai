...
return [
    ...
    [
        ...
        'filter'=> app\models\ServicePage::getListParent()
    ],
    [
        'class'=>'\kartik\grid\DataColumn',
        'attribute'=>'link',
    ...
    [
        ...
        'vAlign'=>'middle',
        'value' => function($model){
            return $model->src ? $this->render('@app/views/blocks/thumbnail-img', ['url' => Yii::getAlias("@webroot/images/main-list/{$model->src}"), 'width' => 200, 'height' => 100]): null;
        },
        'filter'=>false
    ],
    [
        ...
        'template' => '{children} {view} {update} {delete}',
        'buttons' => [
