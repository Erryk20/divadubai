...
return [
    ...
    [
        ...
        'value'=>function($model){
            return Html::a($model->name, ["/{$model->slug}"], ['target'=>"_blank", 'data-pjax'=>0]);
        }
    ],
    [
        'class'=>'\kartik\grid\DataColumn',
    ...
    [
        ...
        'template' => '{content} {media} {seo} {update}',
        ...
        'buttons'=>[
            ...
            'media' => function ($url, $model) {
                return Html::a('<span class="fa fa-picture-o"></span>', 
                    [
                    ...
                    [
                        'title'=>"Media",
                        'data-pjax'=>"0",
                        'class'=>'btn btn-xs btn-warning btn-detail',
                        //'role'=>"modal-remote",
                        //'data-toggle'=>"tooltip",
