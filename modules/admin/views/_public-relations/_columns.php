...
return [
    ...
    [
        ...
        'value'=>function($model){
            return Html::a($model->title, ["/site/production", 'action'=>$model->url], ['target'=>"_blank", 'data-pjax'=>0]);
        }
    ],
    [
        'class'=>'\kartik\grid\DataColumn',
    ...
    [
        ...
        'format' => 'html',
        'value' => function($model){
            return $model->img ? $this->render('@app/views/blocks/thumbnail-img', ['url' => Yii::getAlias("@webroot/images/diva-media/{$model->img}"), 'width' => 200, 'height' => 100]): null;
        },
        'filter'=>false
    ],
    [
        ...
        'urlCreator' => function($action, $model, $key, $index) { 
                return Url::to(["/admin/diva-media/{$action}",'id'=>$key]);
        },
        'buttons'=>[
