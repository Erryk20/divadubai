...
return [
    ...
    // ],
        ...
        [
            ...
            'value' => function($model) {
                return $model['add_management'] ? \app\models\OurWork::itemAlias('type', $model['add_management']) : null;
            },
            'vAlign' => 'middle',
            'filter' => app\models\OurWork::itemAlias('type'),
            'editableOptions' => function ($model, $key, $index) {
                $key = $model->id;
                return [
                    'name' => 'add_management',
                    'value' => \app\models\OurWork::itemAlias('type', $model['add_management']),
                    'asPopover' => true,
                    'header' => 'Type',
                    'inputType' => Editable::INPUT_DROPDOWN_LIST,
                    'data' => ['0' => 'Delete'] + app\models\OurWork::itemAlias('type'),
                    'options' => [
                        'class' => 'form-control',
                        'prompt' => 'Select type...',
                        'name' => 'type',
