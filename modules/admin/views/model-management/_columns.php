...
return [
    ...
    [
        ...
        'vAlign'=>'middle',
        'format'=>'raw',
        'filter'=> UserInfo::itemAlias('gender'),
    ],
    [
        'class'=>'\kartik\grid\DataColumn',
        'attribute'=>'name',
    ...
    [
        ...
        'vAlign' => 'middle',
        'filter' => \app\models\ModelSubcategory::listAllForCategory(4),
                
        'editableOptions' => function ($model, $key, $index) {
            $key = $model->id;
            $data = \app\models\ModelSubcategory::listAllForCategory(4);
            
            return [
                'formOptions' => ['action' => ['/admin/promotions-activations', 'categories'=> [4 => 4]] ],
                'name' => 'subcategory',
                'asPopover' => true,
                'header' => 'Subcategory',
