...
return [
    ...
    [
        ...
        'filter' => \app\models\ModelCategory::getListCategoryEvent(5),
                
//        'filter'=>[
//            'Host'=> 'Host', 
//            'Hostessess'=>'Hostessess',
//            'promoters'=>'Promoters/Activations'
//        ],
    ],
    [
        'class'=>'\kartik\grid\DataColumn',
...
//         'url' => ['change-username'],
        ...
        'vAlign' => 'middle',
        'filter' => app\models\ModelSubcategory::listAllForCategory(38),
//        'ajaxSettings' => [
//            'ids' => '10'
//        ],
//        'url' => '/profile/update',
        ...
        'editableOptions' => function ($model, $key, $index) {
            $key = $model->id;
            $data = app\models\ModelSubcategory::listAllForCategory(38);
            
            return [
                'formOptions' => ['action' => ['/admin/promotions-activations', 'categories'=> \app\models\ModelCategory::getListIdCategoriesForCategory(5)] ],
                'name' => 'subcategory',
                'asPopover' => true,
                'header' => 'Subcategory',
            ...
            return SwitchInput::widget([
                        ...
                        'pluginEvents' => [
                            "switchChange.bootstrapSwitch" => "function() {
                                ...
                                $.ajax({
                                    type: 'GET',
                                    url: '/admin/promotions-activations/active',
                                    data: {id:id},
                                });
                            }",
                        ],
