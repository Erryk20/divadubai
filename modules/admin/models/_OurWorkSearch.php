 ...
 */
class _OurWorkSearch extends UserInfo
{
    ...
    public function search($params)
    {
        ...
        $query->select([
            ...
            "ui.visa_status",
            "ui.specialization",
            "ow.type AS add_management",
        ]);
        $query->from('user_info ui');
        $query->leftJoin('our_work ow', 'ow.info_user_id = ui.id');
        ...
        if($this['add_management'] != NULL){
            $query->andWhere(['ow.type' => ($this['add_management'] == '0') ? NULL : $this->add_management]);
        }
