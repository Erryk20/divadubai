 ...
 */
class _PromotionsActivationsSearch extends UserInfo
{
    ...
    public function rules()
    {
        return [
            ...
            [['gender', 'name', 'last_name', 'gender', 'phone', 'phone2', 'nationality', 'country', 'city', 'ethnicity', 'height', 'add_management', 'suit', 'pant', 'hair', 'hair_length', 'eye', 'language', 'visa_status', 'specialization'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->select([
            ...
            "ui.visa_status",
            "ui.specialization",
            "pa.type AS add_management",
        ]);
        $query->from('user_info ui');
        $query->leftJoin('promotions_activations pa', 'pa.info_user_id = ui.id');
        ...
        if($this['add_management'] != NULL){
            $query->andWhere(['pa.type' => ($this['add_management'] == '0') ? NULL : $this->add_management]);
        }
